...
%     close all
    ...
    selected_missile=[10 2 106 113 91 26 13 21 96 4 122 2 112 121 2 96 22 102 65 123];
    [conf_int_data{i} predgeo{i}]=RealtimeFuzzyClassification(m,c,selected_missile(i),geo_attributes,missile_2_classify,known_geo,plot_on,database_num);
